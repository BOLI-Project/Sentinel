...
sentinel_cfg = BoliConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_bolid_proto_version_with_sentinel_ping = 70207


def get_boli_conf():
    home = os.environ.get('HOME')

    boli_conf = os.path.join(home, ".Bolivarcoin/Bolivarcoin.conf")
    if sys.platform == 'darwin':
        boli_conf = os.path.join(home, "Library/Application Support/Bolivarcoin/Bolivarcoin.conf")

    boli_conf = sentinel_cfg.get('boli_conf', boli_conf)

...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to bolid "gobject list" output
    ...
    def bolid_serialise(self):
        import bolilib
        return bolilib.SHIM_serialise_for_bolid(self.serialise())
